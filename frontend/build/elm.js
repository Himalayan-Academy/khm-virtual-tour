...
{
	if (region.bm.aF === region.bI.aF)
	{
		return 'on line ' + region.bm.aF;
	}
	return 'on lines ' + region.bm.aF + ' through ' + region.bI.aF;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.bg, request.c2, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.c2)));
		}
...
function _Http_configureRequest(xhr, request)
{
	...
	elm$core$Maybe$isJust(request.bp) && (xhr.timeout = request.bp.a);
}
...
function _Http_toResponse(xhr)
{
	return {
		c2: xhr.responseURL,
		cY: { cv: xhr.status, E: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cF: 'hidden', aB: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cF: 'mozHidden', aB: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cF: 'msHidden', aB: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cF: 'webkitHidden', aB: 'webkitvisibilitychange' }
		: { cF: 'hidden', aB: 'visibilitychange' };
}
...
function _Markdown_formatOptions(options)
{
	...
	{
		if (!lang && elm$core$Maybe$isJust(options.bG))
		{
			lang = options.bG.a;
		}
...
var author$project$Main$Model = F3(
	function (key, page, locations) {
		return {bT: key, ak: locations, H: page};
	});
...
var author$project$Types$Image = F2(
	function (image, caption) {
		return {Z: caption, aZ: image};
	});
var elm$json$Json$Decode$string = _Json_decodeString;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Item$decodeImage = A3(
	...
	A3(
		...
		'image',
		elm$json$Json$Decode$string,
		elm$json$Json$Decode$succeed(author$project$Types$Image)));
var author$project$Types$ItemLocationMetadata = F7(
	function (id, title, about, description, heroImage, x, y) {
		return {cm: about, cy: description, cE: heroImage, bO: id, V: title, c6: x, c7: y};
	});
var elm$json$Json$Decode$float = _Json_decodeFloat;
var author$project$Item$decodeItemLocationMetadata = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'y',
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'id',
							elm$json$Json$Decode$string,
							elm$json$Json$Decode$succeed(author$project$Types$ItemLocationMetadata))))))));
var author$project$Types$Video = F4(
	function (kind, poster, caption, video) {
		return {Z: caption, bU: kind, b1: poster, bq: video};
	});
var author$project$Item$decodeVideo = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'video',
	elm$json$Json$Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'kind',
				elm$json$Json$Decode$string,
				elm$json$Json$Decode$succeed(author$project$Types$Video)))));
var author$project$Types$ItemLocation = F6(
	function (metadata, panoramas, videos, quadVideos, slideshows, cached) {
		return {ct: cached, k: metadata, b_: panoramas, b5: quadVideos, bl: slideshows, cj: videos};
	});
var elm$json$Json$Decode$bool = _Json_decodeBool;
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Item$decodeItemLocation = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'cached',
	...
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'slideshows',
		elm$json$Json$Decode$list(author$project$Item$decodeImage),
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'quad-videos',
			elm$json$Json$Decode$list(author$project$Item$decodeVideo),
			A3(
				NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'videos',
				elm$json$Json$Decode$list(author$project$Item$decodeVideo),
				A3(
					...
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'metadata',
						author$project$Item$decodeItemLocationMetadata,
						elm$json$Json$Decode$succeed(author$project$Types$ItemLocation)))))));
var author$project$Types$Item = F2(
	function (status, location) {
		return {bV: location, cY: status};
	});
var author$project$Item$decodeItem = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'location',
	author$project$Item$decodeItemLocation,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'status',
		elm$json$Json$Decode$string,
		elm$json$Json$Decode$succeed(author$project$Types$Item)));
var author$project$Item$env = 'production';
var author$project$Item$whatIsTheCorrectServer = (author$project$Item$env === 'development') ? 'http://localhost:8081' : 'http://dev.himalayanacademy.com/virtualtour/index.php';
...
var author$project$Item$toLocationUrl = function (location) {
	return A3(
		elm$url$Url$Builder$crossOrigin,
		author$project$Item$whatIsTheCorrectServer,
		_List_fromArray(
			['location', location]),
		_List_Nil);
};
var author$project$Main$LocationLoaded = function (a) {
	return {$: 2, a: a};
};
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response.K);
			if (_n0.$ === 1) {
		...
		return elm$http$Http$request(
			{
				...
				bc: elm$http$Http$expectJson(decoder),
				aY: _List_Nil,
				bg: 'GET',
...
var author$project$Main$fetchLocation = function (location) {
	return A2(
		elm$http$Http$send,
		author$project$Main$LocationLoaded,
		A2(
			elm$http$Http$get,
			author$project$Item$toLocationUrl(location),
			author$project$Item$decodeItem));
};
var author$project$Types$Locations = function (locations) {
	return {ak: locations};
};
var author$project$Item$decodeLocations = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'locations',
	elm$json$Json$Decode$list(author$project$Item$decodeItemLocationMetadata),
	elm$json$Json$Decode$succeed(author$project$Types$Locations));
var author$project$Item$toLocationsUrl = A3(
	elm$url$Url$Builder$crossOrigin,
	author$project$Item$whatIsTheCorrectServer,
	_List_fromArray(
		['locations']),
	_List_Nil);
var author$project$Main$LocationsLoaded = function (a) {
	return {$: 3, a: a};
};
var author$project$Main$fetchLocations = A2(
	elm$http$Http$send,
	author$project$Main$LocationsLoaded,
	A2(elm$http$Http$get, author$project$Item$toLocationsUrl, author$project$Item$decodeLocations));
var author$project$Main$NotFound = {$: 0};
var author$project$Main$About = {$: 4};
var author$project$Main$Galleries = function (a) {
	return {$: 2, a: a};
};
...
var author$project$Page$Location$Metadata = 4;
var author$project$Page$Location$Model = F4(
	function (subView, location, data, currentItem) {
		return {L: currentItem, aV: data, bV: location, aq: subView};
	});
var author$project$Page$Location$Panoramas = 0;
var author$project$Page$Location$QuadVideos = 2;
var author$project$Page$Location$Slideshow = 3;
var author$project$Page$Location$Videos = 1;
var author$project$Page$Location$fromStrings = F2(
	function (subViewStr, loc) {
		...
		return A4(author$project$Page$Location$Model, subView, loc, elm$core$Maybe$Nothing, 0);
	});
var author$project$Main$locationWithDefaultSubview = function (loc) {
	return author$project$Main$Location(
		A2(author$project$Page$Location$fromStrings, '', loc));
};
var author$project$Main$locationWithSubview = F2(
	function (loc, subView) {
		return author$project$Main$Location(
			A2(author$project$Page$Location$fromStrings, subView, loc));
	});
var elm$core$String$toInt = _String_toInt;
var elm$url$Url$Parser$Parser = elm$core$Basics$identity;
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {N: frag, R: params, I: unvisited, c3: value, W: visited};
	});
...
var author$project$Main$route = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Main$Map, elm$url$Url$Parser$top),
			A2(
			...
			A2(
			elm$url$Url$Parser$map,
			author$project$Main$Galleries(0),
			elm$url$Url$Parser$s('galleries')),
			A2(
			elm$url$Url$Parser$map,
			author$project$Main$Galleries,
			A2(
			...
			A2(
			elm$url$Url$Parser$map,
			author$project$Main$locationWithDefaultSubview,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('location'),
				elm$url$Url$Parser$string)),
			A2(
			elm$url$Url$Parser$map,
			author$project$Main$locationWithSubview,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('location'),
...
var elm$url$Url$Parser$getFirstMatch = function (states) {
	...
	while (true) {
		if (!states.b) {
			...
			var _n1 = state.I;
			if (!_n1.b) {
				return elm$core$Maybe$Just(state.c3);
			} else {
				if ((_n1.a === '') && (!_n1.b.b)) {
					return elm$core$Maybe$Just(state.c3);
				} else {
		...
		A2(
			...
			_Utils_update(
				url,
				{
					...
					cT: A2(elm$core$Maybe$withDefault, '', url.bL)
				})));
};
var elm$json$Json$Encode$null = _Json_encodeNull;
var author$project$Main$initializeMap = _Platform_outgoingPort(
	'initializeMap',
	function ($) {
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var currentPage = author$project$Main$fromUrl(url);
		var nextCmd = function () {
			switch (currentPage.$) {
				case 3:
					var lm = currentPage.a;
					return author$project$Main$fetchLocation(lm.bV);
				case 1:
					return author$project$Main$initializeMap(0);
				default:
		...
		return _Utils_Tuple2(
			...
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[author$project$Main$fetchLocations, nextCmd])));
	});
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bE: elm$core$Maybe$Nothing, bP: _List_Nil, bY: _List_Nil, cd: snippets};
};
...
var Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {_: charsProcessed, af: hash, S: seed, ao: shift};
	});
...
var Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = data.af ? A2(Skinney$murmur3$Murmur3$mix, data.S, data.af) : data.S;
	var h1 = acc ^ data._;
...
var Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_n0 === 24) {
			...
			return {_: data._ + 1, af: 0, S: newHash, ao: 0};
		} else {
			return {_: data._ + 1, af: res, S: data.S, ao: data.ao + 8};
		}
	});
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	var charset = _n0.bE;
	var imports = _n0.bP;
	var namespaces = _n0.bY;
	var snippets = _n0.cd;
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bE: charset, cx: declarations, bP: imports, bY: namespaces};
};
	...
	function (declaration, _n0) {
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return elm$core$String$isEmpty(record.cw) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3(elm$core$Dict$insert, record.cO, record.cw, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bE: charset, cx: finalDeclarations, bP: imports, bY: namespaces};
};
...
var author$project$Main$toUnstyledDocument = function (doc) {
	return {
		K: A2(elm$core$List$map, rtfeldman$elm_css$Html$Styled$toUnstyled, doc.K),
		V: doc.V
	};
};
var author$project$Main$LocationMsg = function (a) {
	return {$: 4, a: a};
};
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Main$popMarker = _Platform_outgoingPort('popMarker', elm$json$Json$Encode$string);
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bL: fragment, bN: host, cT: path, b0: port_, b4: protocol, b6: query};
	});
...
var author$project$Main$unloadMap = _Platform_outgoingPort(
	'unloadMap',
	function ($) {
		return elm$json$Json$Encode$null;
	});
var author$project$Page$Location$empty = A4(author$project$Page$Location$Model, 4, '', elm$core$Maybe$Nothing, 0);
var author$project$Page$Location$receivedData = F2(
	function (model, item) {
		return _Utils_update(
			model,
			{
				aV: elm$core$Maybe$Just(item)
			});
	});
var elm$json$Json$Encode$int = _Json_wrap;
var author$project$Page$Location$changePanoramaImage = _Platform_outgoingPort('changePanoramaImage', elm$json$Json$Encode$int);
var author$project$Page$Location$changePano = function (id) {
	return author$project$Page$Location$changePanoramaImage(id);
};
var author$project$Page$Location$subViewFromString = function (subViewStr) {
	switch (subViewStr) {
		case 'panoramas':
			return 0;
		case 'videos':
...
var author$project$Page$Location$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var u = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					...
					{
						L: 0,
						aq: author$project$Page$Location$subViewFromString(u)
					}),
			...
			var nextCmd = function () {
				var _n1 = model.aq;
				if (!_n1) {
					return author$project$Page$Location$changePano(i);
				} else {
					return elm$core$Platform$Cmd$none;
				}
			}();
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var url = msg.a;
				var page = author$project$Main$fromUrl(url);
				var nextCmd = function () {
					switch (page.$) {
						case 3:
							var lm = page.a;
							return elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										author$project$Main$fetchLocation(lm.bV),
										author$project$Main$unloadMap(0)
									]));
						case 1:
							return author$project$Main$initializeMap(0);
						default:
							return _Utils_eq(model.H, author$project$Main$Map) ? author$project$Main$unloadMap(0) : author$project$Main$resetViewport;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 2:
				...
				var newPage = function () {
					var _n3 = _Utils_Tuple2(page, i);
					if ((_n3.a.$ === 3) && (!_n3.b.$)) {
						var m = _n3.a.a;
						var data = _n3.b.a;
						return author$project$Main$Location(
							A2(author$project$Page$Location$receivedData, m, data));
					} else {
						return page;
					}
				}();
			...
			case 4:
				...
				var locationModel = function () {
					...
					if (_n6.$ === 3) {
						...
						return author$project$Page$Location$empty;
					}
				}();
				var _n5 = A2(author$project$Page$Location$update, m, locationModel);
				var newModel = _n5.a;
				var locationCmd = _n5.b;
				var nextCmd = A2(elm$core$Platform$Cmd$map, author$project$Main$LocationMsg, locationCmd);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							H: author$project$Main$Location(newModel)
						}),
					nextCmd);
			case 5:
				var id = msg.a;
	...
	K: _List_fromArray(
		[
			...
			A3(
				...
				author$project$Page$About$options,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('content'),
						A2(elm$html$Html$Attributes$style, 'padding', '50px')
					]),
				author$project$Page$About$content))
		]),
	V: 'About'
};
var author$project$Page$Galleries$itemsPerPage = 12;
var author$project$Page$Galleries$urlWithPrefix = F2(
	function (id, url) {
		return 'http://dev.himalayanacademy.com/virtualtour/index.php/thumb/500/' + (id + ('/' + url));
	});
...
var rtfeldman$elm_css$Css$erroneousHex = function (str) {
	return {
		...
		aD: 0,
		aH: 0,
		c3: rtfeldman$elm_css$Css$withPrecedingHash(str)
	};
};
...
var author$project$Ui$Theme$colors = {
	cC: rtfeldman$elm_css$Css$hex('#8c3945'),
	cD: rtfeldman$elm_css$Css$hex('#FFF'),
	cL: rtfeldman$elm_css$Css$hex('#8c3945')
};
...
var author$project$Ui$Theme$ifDesktop = rtfeldman$elm_css$Css$Media$withMedia(
	_List_fromArray(
		[
			A2(
...
var author$project$Ui$Theme$ifMobile = rtfeldman$elm_css$Css$Media$withMedia(
	_List_fromArray(
		[
			A2(
			rtfeldman$elm_css$Css$Media$only,
	...
	function (key, argA, argB, argC) {
		return A2(
			...
			A2(
				...
				' ',
				_List_fromArray(
					[argA.c3, argB.c3, argC.c3])));
	});
var rtfeldman$elm_css$Css$border3 = rtfeldman$elm_css$Css$prop3('border');
var rtfeldman$elm_css$Css$prop1 = F2(
	function (key, arg) {
		return A2(rtfeldman$elm_css$Css$property, key, arg.c3);
	});
var rtfeldman$elm_css$Css$borderRadius = rtfeldman$elm_css$Css$prop1('border-radius');
var rtfeldman$elm_css$Css$center = rtfeldman$elm_css$Css$prop1('center');
var rtfeldman$elm_css$Css$color = function (c) {
	return A2(rtfeldman$elm_css$Css$property, 'color', c.c3);
};
var rtfeldman$elm_css$Css$flexGrow = rtfeldman$elm_css$Css$prop1('flex-grow');
var rtfeldman$elm_css$Css$hidden = {p: 0, al: 0, c3: 'hidden', aR: 0};
...
var rtfeldman$elm_css$Css$int = function (val) {
	return {
		...
		au: '',
		aQ: 0,
		c3: elm$core$String$fromInt(val)
	};
};
var rtfeldman$elm_css$Css$maxHeight = rtfeldman$elm_css$Css$prop1('max-height');
var rtfeldman$elm_css$Css$maxWidth = rtfeldman$elm_css$Css$prop1('max-width');
var rtfeldman$elm_css$Css$none = {X: 0, bz: 0, p: 0, a: 0, f: 0, cG: 0, bR: 0, bf: 0, aj: 0, O: 0, w: 0, c: 0, b: 0, bh: 0, a2: 0, cU: 0, t: 0, a3: 0, cW: 0, ar: 0, U: 0, r: 0, e: 0, c1: 0, c3: 'none'};
var rtfeldman$elm_css$Css$outline = rtfeldman$elm_css$Css$prop1('outline');
var rtfeldman$elm_css$Css$overflow = rtfeldman$elm_css$Css$prop1('overflow');
var rtfeldman$elm_css$Css$PercentageUnits = 0;
var rtfeldman$elm_css$Css$pct = A2(rtfeldman$elm_css$Css$Internal$lengthConverter, 0, '%');
var rtfeldman$elm_css$Css$solid = {p: 0, T: 0, c3: 'solid'};
...
var author$project$Page$Galleries$location = function (l) {
	return A2(
		...
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Html$Styled$Attributes$href('#/location/' + l.bO)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Css$color(author$project$Ui$Theme$colors.cL)
							]))
					]),
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(l.V)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						A2(author$project$Page$Galleries$urlWithPrefix, l.bO, l.cE)),
						rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(l.cm)
					]))
			]));
};
...
var author$project$Page$Galleries$locations = F2(
	function (pageNum, model) {
		var total = elm$core$List$length(model.ak);
		var items = A2(
			elm$core$List$take,
			author$project$Page$Galleries$itemsPerPage,
			A2(elm$core$List$drop, pageNum * author$project$Page$Galleries$itemsPerPage, model.ak));
		return A2(elm$core$List$map, author$project$Page$Galleries$location, items);
	});
...
var author$project$Page$Galleries$pagination = F2(
	function (pageNum, numberOfItems) {
		var page = function (n) {
			return _Utils_eq(n, pageNum) ? A2(
					...
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Css$fontSize(
								rtfeldman$elm_css$Css$rem(2)),
								rtfeldman$elm_css$Css$color(author$project$Ui$Theme$colors.cC),
								rtfeldman$elm_css$Css$width(
								rtfeldman$elm_css$Css$px(80)),
								rtfeldman$elm_css$Css$textDecoration(rtfeldman$elm_css$Css$none)
							])),
						rtfeldman$elm_css$Html$Styled$Attributes$href(
						'#/galleries/' + elm$core$String$fromInt(n))
					]),
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(
		...
		var numberOfPages = ((numberOfItems / author$project$Page$Galleries$itemsPerPage) | 0) + 1;
		var pages = A2(elm$core$List$range, 0, numberOfPages);
		var pageElements = A2(elm$core$List$map, page, pages);
		return A2(
...
var feathericons$elm_feather$FeatherIcons$makeBuilder = F2(
	function (name, src) {
		return {
			l: feathericons$elm_feather$FeatherIcons$defaultAttributes(name),
			o: src
		};
	});
...
var feathericons$elm_feather$FeatherIcons$toHtml = F2(
	function (attributes, _n0) {
		var src = _n0.o;
		var attrs = _n0.l;
		var strSize = elm$core$String$fromFloat(attrs.a6);
		var baseAttributes = _List_fromArray(
			[
				elm$svg$Svg$Attributes$fill('none'),
				elm$svg$Svg$Attributes$height(
				_Utils_ap(strSize, attrs.aJ)),
				...
				elm$svg$Svg$Attributes$viewBox(attrs.ba)
			]);
...
var rtfeldman$elm_css$Css$calc = F3(
	function (firstExpr, expression, secondExpr) {
		var withoutCalcStr = function (l) {
			return A2(elm$core$String$startsWith, 'calc(', l.c3) ? A2(elm$core$String$dropLeft, 4, l.c3) : l.c3;
		};
		var calcs = A2(
			elm$core$String$join,
			' ',
		...
		var value = A2(
			...
			_List_fromArray(
				[calcs]));
		return {bB: 0, ac: 0, m: 0, aE: 0, ah: 0, D: 0, ai: 0, aj: 0, O: 0, P: 0, w: 0, as: 0, c3: value};
	});
var rtfeldman$elm_css$Css$row = {be: 0, aC: 0, c3: 'row'};
...
var rtfeldman$elm_css$Css$num = function (val) {
	return {
		...
		au: '',
		aQ: 0,
		c3: elm$core$String$fromFloat(val)
	};
};
...
var author$project$Ui$Loading$view = function () {
	var loadIcon = rtfeldman$elm_css$Html$Styled$fromUnstyled(
		A2(
			...
			A2(
				...
				A2(
					...
					'px',
					A2(feathericons$elm_feather$FeatherIcons$withSize, 60, feathericons$elm_feather$FeatherIcons$loader)))));
	return _List_fromArray(
		[
			A2(
			rtfeldman$elm_css$Html$Styled$div,
...
var rtfeldman$elm_css$Css$wrap = {aC: 0, aX: 0, c3: 'wrap'};
var author$project$Page$Galleries$view = F2(
	function (pageNum, model) {
		return (elm$core$List$length(model.ak) > 0) ? {
			K: _List_fromArray(
				[
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					...
					A2(author$project$Page$Galleries$locations, pageNum, model)),
					A2(
					author$project$Page$Galleries$pagination,
					pageNum,
					elm$core$List$length(model.ak))
				]),
			V: 'Galleries'
		} : {K: author$project$Ui$Loading$view, V: 'Loading Galleries...'};
	});
var author$project$Page$Location$ChangeSubView = function (a) {
	return {$: 0, a: a};
};
...
var rtfeldman$elm_css$Css$pointer = {a: 0, c3: 'pointer'};
...
var author$project$Page$Location$navigation = F4(
	function (id, label, url, active) {
		var borderIfActive = active ? A3(
			rtfeldman$elm_css$Css$borderBottom3,
			rtfeldman$elm_css$Css$px(3),
			rtfeldman$elm_css$Css$solid,
			rtfeldman$elm_css$Css$hex('#8c3945')) : rtfeldman$elm_css$Css$border(
...
var rtfeldman$elm_css$Css$stringsToValue = function (list) {
	return elm$core$List$isEmpty(list) ? {c3: 'none'} : {
		c3: A2(
			elm$core$String$join,
			', ',
			A2(
...
var rtfeldman$elm_css$Css$sansSerif = {M: 0, c3: 'sans-serif'};
...
var author$project$Page$Location$header = function (model) {
	var isActive = function (s) {
		var m = A2(author$project$Page$Location$fromStrings, s, model.bV);
		return _Utils_eq(model.aq, m.aq);
	};
	var hasContent = F2(
		function (l, h) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(d.bV.k.V)
							])),
						A2(
...
var author$project$Page$Location$loadingView = function () {
	var loadIcon = rtfeldman$elm_css$Html$Styled$fromUnstyled(
		A2(
			feathericons$elm_feather$FeatherIcons$toHtml,
			_List_Nil,
...
var author$project$Page$Location$urlWithPrefix = function (url) {
	return 'http://dev.himalayanacademy.com/virtualtour/' + url;
};
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {cI: index, cM: match, cP: number, cZ: submatches};
	});
...
var author$project$Page$Location$makeThumb = F2(
	function (size, url) {
		var needle = 'points-of-interest/';
		var change = 'index.php/thumb/' + (elm$core$String$fromInt(size) + '/');
		return author$project$Page$Location$urlWithPrefix(
			A3(elm_community$string_extra$String$Extra$replace, needle, change, url));
	});
var rtfeldman$elm_css$Css$backgroundColor = function (c) {
	return A2(rtfeldman$elm_css$Css$property, 'background-color', c.c3);
};
...
var author$project$Page$Location$metadataView = function (data) {
	var metadata = data.bV.k;
	return _List_fromArray(
		[
			A2(
			rtfeldman$elm_css$Html$Styled$div,
			...
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									rtfeldman$elm_css$Html$Styled$Attributes$src(
									A2(author$project$Page$Location$makeThumb, 500, metadata.cE))
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									A4(rtfeldman$elm_css$Css$rgba, 240, 240, 240, 0.4)),
									rtfeldman$elm_css$Css$borderRadius(
									rtfeldman$elm_css$Css$px(20)),
									rtfeldman$elm_css$Css$fontSize(
									rtfeldman$elm_css$Css$px(20)),
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text(metadata.cy)
						]))
				]))
		]);
};
var author$project$Page$Location$ChangeCurrentItem = function (a) {
	return {$: 1, a: a};
};
var author$project$Types$brokenImage = {Z: 'broken image', aZ: ''};
...
var author$project$Page$Location$panoramasView = F2(
	function (data, index) {
		var metadata = data.bV.k;
		var images = data.bV.b_;
		var thumbs = A2(
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								rtfeldman$elm_css$Html$Styled$Attributes$src(
								A2(author$project$Page$Location$makeThumb, 200, image.aZ)),
								rtfeldman$elm_css$Html$Styled$Events$onClick(
								author$project$Page$Location$ChangeCurrentItem(i))
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(image.Z)
							]));
				}),
			images);
		var currentImage = A2(
			...
			A2(elm_community$list_extra$List$Extra$getAt, index, images));
		var assets = A2(
			elm$core$List$indexedMap,
			F2(
				function (i, image) {
					return A2(
						...
						_List_fromArray(
							[
								...
								'img-' + elm$core$String$fromInt(i)),
								rtfeldman$elm_css$Html$Styled$Attributes$src(
								author$project$Page$Location$urlWithPrefix(image.aZ)),
								A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'crossorigin', 'anonymous')
							]),
						_List_Nil);
				}),
			images);
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'embedded', 'true'),
												rtfeldman$elm_css$Html$Styled$Attributes$css(
												_List_fromArray(
													[
														rtfeldman$elm_css$Css$borderRadius(
														...
														rtfeldman$elm_css$Css$height(
														rtfeldman$elm_css$Css$px(480))
													]))
											]),
										_List_fromArray(
											[
												A3(rtfeldman$elm_css$Html$Styled$node, 'a-assets', _List_Nil, assets),
												A3(
												rtfeldman$elm_css$Html$Styled$node,
												'a-sky',
												_List_fromArray(
													[
														rtfeldman$elm_css$Html$Styled$Attributes$id('image-360'),
														A2(
														rtfeldman$elm_css$Html$Styled$Attributes$attribute,
														'src',
														'#img-' + elm$core$String$fromInt(index)),
														A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'rotation', '0 -20 0')
													]),
												_List_Nil)
											])),
										A2(
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$text(currentImage.Z)
									]))
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Page$Location$slideshowsView = F2(
	function (data, index) {
		var slideshows = data.bV.bl;
		var metadata = data.bV.k;
		var images = data.bV.bl;
		var thumbs = A2(
			elm$core$List$indexedMap,
			F2(
				function (i, image) {
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$src(
										A2(author$project$Page$Location$makeThumb, 800, currentImage.aZ)),
										rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[
												rtfeldman$elm_css$Css$borderRadius(
...
var author$project$Types$brokenVideo = {Z: 'broken video', bU: 'video', b1: '', bq: ''};
...
var author$project$Page$Location$videosView = F3(
	function (data, videos, index) {
		var thumbs = A2(
			elm$core$List$indexedMap,
			F2(
				function (i, video) {
					var poster = function () {
						var _n1 = video.bU;
						if (_n1 === 'youtube') {
							return 'http://img.youtube.com/vi/' + (video.bq + '/maxresdefault.jpg');
						} else {
							return A2(author$project$Page$Location$makeThumb, 200, video.b1);
						}
					}();
					return A2(
						rtfeldman$elm_css$Html$Styled$img,
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(video.Z)
							]));
				}),
			videos);
		var metadata = data.bV.k;
		var currentVideo = A2(
			elm$core$Maybe$withDefault,
			author$project$Types$brokenVideo,
			A2(elm_community$list_extra$List$Extra$getAt, index, videos));
		var videoOrYoutube = function () {
			var _n0 = currentVideo.bU;
			switch (_n0) {
				case 'video':
					return A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$src(
								author$project$Page$Location$urlWithPrefix(currentVideo.bq)),
								A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'controls', 'true'),
								A2(
								rtfeldman$elm_css$Html$Styled$Attributes$attribute,
								'poster',
								author$project$Page$Location$urlWithPrefix(currentVideo.b1)),
								rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[
										author$project$Ui$Theme$ifDesktop(
				...
				case 'youtube':
					return A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$class('embed-container')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$src('https://www.youtube.com/embed/' + currentVideo.bq),
				...
				default:
					return A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('broken video')
							]));
			}
		}();
		return _List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$text(currentVideo.Z)
									]))
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$class('meleca')
						]),
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('meleca')
						]))
				]))
		]);
};
var author$project$Page$Location$view = F2(
	function (locations, model) {
		var _n0 = function () {
			var _n1 = _Utils_Tuple2(model.aV, model.aq);
			if (_n1.a.$ === 1) {
				var _n2 = _n1.a;
				return _Utils_Tuple2('loading...', author$project$Page$Location$loadingView);
			} else {
				switch (_n1.b) {
					case 4:
						var d = _n1.a.a;
						...
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										author$project$Page$Location$metadataView(d),
										author$project$Ui$Slider$slider(locations)
									])));
					case 3:
						var d = _n1.a.a;
						var _n4 = _n1.b;
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										A2(author$project$Page$Location$slideshowsView, d, model.L)
									])));
					case 0:
						var d = _n1.a.a;
						var _n5 = _n1.b;
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										A2(author$project$Page$Location$panoramasView, d, model.L)
									])));
					case 1:
						var d = _n1.a.a;
						var _n6 = _n1.b;
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										A3(author$project$Page$Location$videosView, d, d.bV.cj, model.L)
									])));
					default:
						var d = _n1.a.a;
						var _n7 = _n1.b;
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										A3(author$project$Page$Location$videosView, d, d.bV.b5, model.L)
									])));
				}
			}
		}();
...
var author$project$Page$Map$locationToItem = F2(
	function (popper, location) {
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text(location.V)
						]))
				]));
	});
var rtfeldman$elm_css$Html$Styled$Attributes$target = rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('target');
var author$project$Ui$SocialButtons$socialButton = F3(
	function (url, label, iconPath) {
		return A2(
			rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
...
var rtfeldman$elm_css$Css$fixed = {az: 0, aG: 0, a8: 0, c3: 'fixed'};
var rtfeldman$elm_css$Css$position = rtfeldman$elm_css$Css$prop1('position');
var rtfeldman$elm_css$Css$zIndex = rtfeldman$elm_css$Css$prop1('z-index');
var author$project$Ui$SocialButtons$buttons = A2(
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			rtfeldman$elm_css$Html$Styled$Attributes$css(
	...
	_List_fromArray(
		[
			A3(author$project$Ui$SocialButtons$socialButton, 'https://www.himalayanacademy.com/blog/taka', 'Blog', 'https://dev.himalayanacademy.com/virtualtour/points-of-interest/khm_logo.png'),
			A3(author$project$Ui$SocialButtons$socialButton, 'https://www.facebook.com/KauaiHinduMonastery/', 'Facebook', 'https://dev.himalayanacademy.com/virtualtour/points-of-interest/facebook.png'),
			A3(author$project$Ui$SocialButtons$socialButton, 'https://www.instagram.com/kauaishindumonastery/', 'Instagram', 'https://dev.himalayanacademy.com/virtualtour/points-of-interest/instagram.png'),
			A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
...
var rtfeldman$elm_css$Css$repeat = {Y: 0, z: 0, c3: 'repeat'};
var rtfeldman$elm_css$Css$scroll = {az: 0, bz: 0, bR: 0, al: 0, cX: 0, c3: 'scroll'};
var rtfeldman$elm_css$Css$url = function (urlValue) {
	return {X: 0, c3: 'url(' + (urlValue + ')')};
};
var author$project$Page$Map$view = F2(
	function (popper, locations) {
		return {
			K: _List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$id('mapid'),
									rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											A2(
											...
											A3(
												...
												rtfeldman$elm_css$Css$px(60))),
											rtfeldman$elm_css$Css$backgroundColor(
											rtfeldman$elm_css$Css$hex('#746e24')),
											rtfeldman$elm_css$Css$backgroundImage(
											rtfeldman$elm_css$Css$url('http://dev.himalayanacademy.com/virtualtour/points-of-interest/bg2.jpg')),
							...
							_List_fromArray(
								[
									...
									A2(
										elm$core$List$map,
										author$project$Page$Map$locationToItem(popper),
										locations))
								]))
						])),
					author$project$Ui$SocialButtons$buttons
				]),
			V: 'Map'
		};
	});
var author$project$Ui$Navigation$navIcon = F4(
	function (icon, label, url, active) {
		var borderIfActive = active ? A3(
			rtfeldman$elm_css$Css$borderBottom3,
			rtfeldman$elm_css$Css$px(3),
			rtfeldman$elm_css$Css$solid,
			rtfeldman$elm_css$Css$hex('#fff')) : rtfeldman$elm_css$Css$border(
			rtfeldman$elm_css$Css$px(0));
		return A2(
			rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
		...
		[
			...
			_List_fromArray(
				[
					...
					elm$svg$Svg$Attributes$strokeLinecap('round'),
					elm$svg$Svg$Attributes$strokeLinejoin('round'),
					elm$svg$Svg$Attributes$class('feather feather-image')
				]),
			_List_fromArray(
				[
					A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					elm$svg$Svg$Attributes$strokeLinecap('round'),
					elm$svg$Svg$Attributes$strokeLinejoin('round'),
					elm$svg$Svg$Attributes$class('feather feather-info')
				]),
			_List_fromArray(
				[
					A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					elm$svg$Svg$Attributes$strokeLinecap('round'),
					elm$svg$Svg$Attributes$strokeLinejoin('round'),
					elm$svg$Svg$Attributes$class('feather feather-map')
				]),
			_List_fromArray(
				[
					A2(
...
var author$project$Ui$Navigation$header = function () {
	var mapIcon = rtfeldman$elm_css$Html$Styled$fromUnstyled(
		A2(feathericons$elm_feather$FeatherIcons$toHtml, _List_Nil, feathericons$elm_feather$FeatherIcons$map));
	var galleriesIcon = rtfeldman$elm_css$Html$Styled$fromUnstyled(
		A2(feathericons$elm_feather$FeatherIcons$toHtml, _List_Nil, feathericons$elm_feather$FeatherIcons$image));
	var aboutIcon = rtfeldman$elm_css$Html$Styled$fromUnstyled(
		A2(feathericons$elm_feather$FeatherIcons$toHtml, _List_Nil, feathericons$elm_feather$FeatherIcons$info));
	return A2(
		rtfeldman$elm_css$Html$Styled$nav,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$displayFlex,
						rtfeldman$elm_css$Css$backgroundColor(author$project$Ui$Theme$colors.cC),
						rtfeldman$elm_css$Css$color(author$project$Ui$Theme$colors.cD),
						author$project$Ui$Theme$ifMobile(
						_List_fromArray(
							[
								rtfeldman$elm_css$Css$flexDirection(rtfeldman$elm_css$Css$column)
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$href('#/map'),
								rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[
										rtfeldman$elm_css$Css$textDecoration(rtfeldman$elm_css$Css$none),
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('Kauai\'s Hindu Monastery Virtual Tour')
							]))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$ul,
				...
				_List_fromArray(
					[
						A4(author$project$Ui$Navigation$navIcon, mapIcon, 'Map', '#/map', false),
						A4(author$project$Ui$Navigation$navIcon, galleriesIcon, 'Galleries', '#/galleries', false),
						A4(author$project$Ui$Navigation$navIcon, aboutIcon, 'About', '#/about', false)
					]))
			]));
}();
...
var author$project$Main$view = function (model) {
	var subView = function () {
		...
		switch (_n0.$) {
			case 1:
				return A2(author$project$Page$Map$view, author$project$Main$PopMarker, model.ak);
			case 3:
				var m = _n0.a;
				var ld = A2(author$project$Page$Location$view, model.ak, m);
				var newBody = A2(
					elm$core$List$map,
					function (x) {
						return A2(rtfeldman$elm_css$Html$Styled$map, author$project$Main$LocationMsg, x);
					},
					ld.K);
				return {K: newBody, V: ld.V};
			case 4:
				return author$project$Page$About$view;
			case 2:
				var pageNum = _n0.a;
				return A2(author$project$Page$Galleries$view, pageNum, model);
			default:
				return {
					K: _List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											rtfeldman$elm_css$Html$Styled$text('Resource Not Found')
										]))
								]))
						]),
					V: 'Virtual Tour - Kaua\'i Hindu Monastery'
				};
		}
	}();
	var title = subView.V;
	return {
		K: elm$core$List$concat(
			_List_fromArray(
				[
					_List_fromArray(
					[author$project$Ui$Navigation$header]),
					subView.K
				])),
		V: title + ' - Kauai Hindu Monastery Virtual Tour'
	};
};
var elm$browser$Browser$application = _Browser_application;
var author$project$Main$main = elm$browser$Browser$application(
	{
		cJ: author$project$Main$init,
		cQ: author$project$Main$UrlChanged,
		cR: author$project$Main$UrlRequested,
		c_: author$project$Main$subscriptions,
		c0: author$project$Main$update,
		c4: A2(elm$core$Basics$composeR, author$project$Main$view, author$project$Main$toUnstyledDocument)
	});
