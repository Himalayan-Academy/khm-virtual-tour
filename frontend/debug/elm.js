...
var author$project$Main$Model = F3(
	function (key, page, locations) {
		return {key: key, locations: locations, page: page};
	});
...
var author$project$Types$ItemLocationMetadata = F7(
	function (id, title, about, description, heroImage, x, y) {
		return {about: about, description: description, heroImage: heroImage, id: id, title: title, x: x, y: y};
	});
...
var author$project$Types$Video = F4(
	function (kind, poster, caption, video) {
		return {caption: caption, kind: kind, poster: poster, video: video};
	});
...
var author$project$Types$ItemLocation = F6(
	function (metadata, panoramas, videos, quadVideos, slideshows, cached) {
		return {cached: cached, metadata: metadata, panoramas: panoramas, quadVideos: quadVideos, slideshows: slideshows, videos: videos};
	});
...
var author$project$Main$Galleries = function (a) {
	return {$: 'Galleries', a: a};
};
var author$project$Main$Map = {$: 'Map'};
var author$project$Main$Location = function (a) {
	return {$: 'Location', a: a};
};
var author$project$Page$Location$Metadata = {$: 'Metadata'};
var author$project$Page$Location$Model = F4(
	function (subView, location, data, currentItem) {
		return {currentItem: currentItem, data: data, location: location, subView: subView};
	});
var author$project$Page$Location$Panoramas = {$: 'Panoramas'};
var author$project$Page$Location$QuadVideos = {$: 'QuadVideos'};
var author$project$Page$Location$Slideshow = {$: 'Slideshow'};
var author$project$Page$Location$Videos = {$: 'Videos'};
var author$project$Page$Location$fromStrings = F2(
	function (subViewStr, loc) {
		var subView = function () {
			switch (subViewStr) {
				case 'panoramas':
					return author$project$Page$Location$Panoramas;
				case 'videos':
					return author$project$Page$Location$Videos;
				case 'videos4k':
					return author$project$Page$Location$QuadVideos;
				case 'slideshows':
					return author$project$Page$Location$Slideshow;
				default:
					return author$project$Page$Location$Metadata;
			}
		}();
		...
		var nextCmd = function () {
			switch (currentPage.$) {
				case 'Location':
					...
					return author$project$Main$fetchLocation(lm.location);
				case 'Map':
					return author$project$Main$initializeMap(_Utils_Tuple0);
				default:
...
var author$project$Page$Location$empty = A4(author$project$Page$Location$Model, author$project$Page$Location$Metadata, '', elm$core$Maybe$Nothing, 0);
var author$project$Page$Location$receivedData = F2(
	function (model, item) {
		return _Utils_update(
			model,
			{
				data: elm$core$Maybe$Just(item)
			});
	});
		...
		if (msg.$ === 'ChangeSubView') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					...
					{
						currentItem: 0,
						subView: author$project$Page$Location$subViewFromString(u)
					}),
				elm$core$Platform$Cmd$none);
		} else {
			var i = msg.a;
			var nextCmd = function () {
				var _n1 = model.subView;
				if (_n1.$ === 'Panoramas') {
					...
					switch (page.$) {
						case 'Location':
							...
							return elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										author$project$Main$fetchLocation(lm.location),
										author$project$Main$unloadMap(_Utils_Tuple0)
									]));
						case 'Map':
							return author$project$Main$initializeMap(_Utils_Tuple0);
						default:
							return _Utils_eq(model.page, author$project$Main$Map) ? author$project$Main$unloadMap(_Utils_Tuple0) : author$project$Main$resetViewport;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'LocationMsg':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: author$project$Main$Location(newModel)
						}),
					nextCmd);
			case 'PopMarker':
				var id = msg.a;
...
var author$project$Ui$Theme$colors = {
	headerBackground: rtfeldman$elm_css$Css$hex('#8c3945'),
	headerForeground: rtfeldman$elm_css$Css$hex('#FFF'),
	marroon: rtfeldman$elm_css$Css$hex('#8c3945')
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Html$Styled$Attributes$href('#/location/' + l.id)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Css$color(author$project$Ui$Theme$colors.marroon)
							]))
					]),
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(l.title)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						A2(author$project$Page$Galleries$urlWithPrefix, l.id, l.heroImage)),
						rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(l.about)
					]))
			]));
};
...
var author$project$Page$Galleries$locations = F2(
	function (pageNum, model) {
		var total = elm$core$List$length(model.locations);
		var items = A2(
			elm$core$List$take,
			author$project$Page$Galleries$itemsPerPage,
			A2(elm$core$List$drop, pageNum * author$project$Page$Galleries$itemsPerPage, model.locations));
					...
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Css$fontSize(
								rtfeldman$elm_css$Css$rem(2)),
								rtfeldman$elm_css$Css$color(author$project$Ui$Theme$colors.headerBackground),
								rtfeldman$elm_css$Css$width(
								rtfeldman$elm_css$Css$px(80)),
								rtfeldman$elm_css$Css$textDecoration(rtfeldman$elm_css$Css$none)
							])),
...
var author$project$Page$Galleries$view = F2(
	function (pageNum, model) {
		return (elm$core$List$length(model.locations) > 0) ? {
			body: _List_fromArray(
				[
					A2(
					rtfeldman$elm_css$Html$Styled$div,
					...
					pageNum,
					elm$core$List$length(model.locations))
				]),
			title: 'Galleries'
		} : {body: author$project$Ui$Loading$view, title: 'Loading Galleries...'};
	});
var author$project$Page$Location$ChangeSubView = function (a) {
	return {$: 'ChangeSubView', a: a};
};
...
var author$project$Page$Location$header = function (model) {
	var isActive = function (s) {
		var m = A2(author$project$Page$Location$fromStrings, s, model.location);
		return _Utils_eq(model.subView, m.subView);
	};
	var hasContent = F2(
		function (l, h) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(d.location.metadata.title)
							])),
						A2(
...
var author$project$Page$Location$metadataView = function (data) {
	var metadata = data.location.metadata;
	return _List_fromArray(
		[
			A2(
			rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Page$Location$ChangeCurrentItem = function (a) {
	return {$: 'ChangeCurrentItem', a: a};
};
var author$project$Types$brokenImage = {caption: 'broken image', image: ''};
...
var author$project$Page$Location$panoramasView = F2(
	function (data, index) {
		var metadata = data.location.metadata;
		var images = data.location.panoramas;
		var thumbs = A2(
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								rtfeldman$elm_css$Html$Styled$Attributes$src(
								A2(author$project$Page$Location$makeThumb, 200, image.image)),
								rtfeldman$elm_css$Html$Styled$Events$onClick(
								author$project$Page$Location$ChangeCurrentItem(i))
							]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(image.caption)
							]));
				}),
			images);
		var currentImage = A2(
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								rtfeldman$elm_css$Html$Styled$Attributes$src(
								author$project$Page$Location$urlWithPrefix(image.image)),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$text(currentImage.caption)
									]))
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Page$Location$slideshowsView = F2(
	function (data, index) {
		var slideshows = data.location.slideshows;
		var metadata = data.location.metadata;
		var images = data.location.slideshows;
		var thumbs = A2(
			elm$core$List$indexedMap,
			F2(
				function (i, image) {
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$src(
										A2(author$project$Page$Location$makeThumb, 800, currentImage.image)),
										rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[
												rtfeldman$elm_css$Css$borderRadius(
...
var author$project$Types$brokenVideo = {caption: 'broken video', kind: 'video', poster: '', video: ''};
			...
			F2(
				function (i, video) {
					var poster = function () {
						var _n1 = video.kind;
						if (_n1 === 'youtube') {
							return 'http://img.youtube.com/vi/' + (video.video + '/maxresdefault.jpg');
						} else {
							return A2(author$project$Page$Location$makeThumb, 200, video.poster);
						}
					}();
					return A2(
						rtfeldman$elm_css$Html$Styled$img,
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(video.caption)
							]));
				}),
			videos);
		var metadata = data.location.metadata;
				...
				case 'video':
					return A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$src(
								author$project$Page$Location$urlWithPrefix(currentVideo.video)),
								A2(rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'controls', 'true'),
								A2(
								rtfeldman$elm_css$Html$Styled$Attributes$attribute,
								'poster',
								author$project$Page$Location$urlWithPrefix(currentVideo.poster)),
								rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[
										author$project$Ui$Theme$ifDesktop(
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$src('https://www.youtube.com/embed/' + currentVideo.video),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$text(currentVideo.caption)
									]))
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Page$Location$wrapperInSlider = F3(
	function (model, locations, subView) {
		var isActive = function (s) {
			var m = A2(author$project$Page$Location$fromStrings, s, model.location);
			return _Utils_eq(model.subView, m.subView);
		};
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														rtfeldman$elm_css$Css$backgroundColor(
														rtfeldman$elm_css$Css$hex('c3c3c3')),
														A2(
														rtfeldman$elm_css$Css$flex2,
														rtfeldman$elm_css$Css$int(1),
														rtfeldman$elm_css$Css$int(1)),
...
var author$project$Page$Location$view = F2(
	function (locations, model) {
		var _n0 = function () {
			var _n1 = _Utils_Tuple2(model.data, model.subView);
			if (_n1.a.$ === 'Nothing') {
				var _n2 = _n1.a;
						...
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										A2(author$project$Page$Location$slideshowsView, d, model.currentItem)
									])));
					case 'Panoramas':
						var d = _n1.a.a;
						var _n5 = _n1.b;
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										A2(author$project$Page$Location$panoramasView, d, model.currentItem)
									])));
					case 'Videos':
						var d = _n1.a.a;
						var _n6 = _n1.b;
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										A3(author$project$Page$Location$videosView, d, d.location.videos, model.currentItem)
									])));
					default:
						var d = _n1.a.a;
						var _n7 = _n1.b;
						return _Utils_Tuple2(
							...
							elm$core$List$concat(
								_List_fromArray(
									[
										author$project$Page$Location$header(model),
										A3(author$project$Page$Location$videosView, d, d.location.quadVideos, model.currentItem)
									])));
				}
			}
		}();
		...
		var subView = _n0.b;
		return {
			body: A3(author$project$Page$Location$wrapperInSlider, model, locations, subView),
			title: title
		};
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text(location.title)
						]))
				]));
	});
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$displayFlex,
						rtfeldman$elm_css$Css$backgroundColor(author$project$Ui$Theme$colors.headerBackground),
						rtfeldman$elm_css$Css$color(author$project$Ui$Theme$colors.headerForeground),
						author$project$Ui$Theme$ifMobile(
						_List_fromArray(
							[
								rtfeldman$elm_css$Css$flexDirection(rtfeldman$elm_css$Css$column)
...
var author$project$Main$view = function (model) {
	var subView = function () {
		...
		switch (_n0.$) {
			case 'Map':
				return A2(author$project$Page$Map$view, author$project$Main$PopMarker, model.locations);
			case 'Location':
				var m = _n0.a;
				var ld = A2(author$project$Page$Location$view, model.locations, m);
				var newBody = A2(
					elm$core$List$map,
					function (x) {
					...
					ld.body);
				return {body: newBody, title: ld.title};
			case 'About':
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		view: A2(elm$core$Basics$composeR, author$project$Main$view, author$project$Main$toUnstyledDocument)
	});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Types.Image":{"args":[],"type":"{ image : String.String, caption : String.String }"},"Types.Item":{"args":[],"type":"{ status : String.String, location : Types.ItemLocation }"},"Types.ItemLocation":{"args":[],"type":"{ metadata : Types.ItemLocationMetadata, panoramas : List.List Types.Image, videos : List.List Types.Video, quadVideos : List.List Types.Video, slideshows : List.List Types.Image, cached : Basics.Bool }"},"Types.ItemLocationMetadata":{"args":[],"type":"{ id : String.String, title : String.String, about : String.String, description : String.String, heroImage : String.String, x : Basics.Float, y : Basics.Float }"},"Types.Locations":{"args":[],"type":"{ locations : List.List Types.ItemLocationMetadata }"},"Types.Video":{"args":[],"type":"{ kind : String.String, poster : String.String, caption : String.String, video : String.String }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UrlRequested":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"LocationLoaded":["Result.Result Http.Error Types.Item"],"LocationsLoaded":["Result.Result Http.Error Types.Locations"],"LocationMsg":["Page.Location.Msg"],"PopMarker":["String.String"],"NoOp":[]}},"Page.Location.Msg":{"args":[],"tags":{"ChangeSubView":["String.String"],"ChangeCurrentItem":["Basics.Int"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));